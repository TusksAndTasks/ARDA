...
function PersonalCabinet() {
  return (
    <div className="lg:vertical-container-lg sm:vertical-container-sm custom-scrollbar-item flex h-full overflow-y-auto overflow-x-hidden sm:overflow-y-auto">
      <CabinetNavigation />
      <Routes>
